...
public class BovineBlocks {
    ...
    public static final RegistryObject<Block> TROPICAL_BLUE = register("tropical_blue", () -> new FlowerBlock(MobEffects.DAMAGE_BOOST, 2, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> POTTED_TROPICAL_BLUE = register("potted_tropical_blue", () -> new FlowerPotBlock(TROPICAL_BLUE.get(), BlockBehaviour.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
