...
public class MushroomCowConfiguration extends CowTypeConfiguration {
    ...
    public static final Codec<MushroomCowConfiguration> CODEC = RecordCodecBuilder.create(builder -> builder.group(
                Settings.getCodec().forGetter(MushroomCowConfiguration::getSettings),
                ...
                BreedingConditionConfiguration.getCodec().optionalFieldOf("breeding_conditions").orElseGet(Optional::empty).forGetter(MushroomCowConfiguration::getBreedingConditions)
