...
public class BovineBlocks {
    ...
    public static final RegistryObject<Block> HYACINTH = register("hyacinth", () -> new FlowerBlock(MobEffects.FIRE_RESISTANCE, 4, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
