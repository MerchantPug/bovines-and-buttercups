...
public class BovineRegistryKeys {
    ...
    public static final ResourceKey<Registry<ConfiguredCowType<?, ?>>> CONFIGURED_COW_TYPE_KEY = ResourceKey.createRegistryKey(Constants.resourceLocation("configured_cow_type"));
}
