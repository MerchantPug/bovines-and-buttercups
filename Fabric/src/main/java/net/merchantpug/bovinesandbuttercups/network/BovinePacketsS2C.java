...
public class BovinePacketsS2C {
    ...
    public static <T extends BovinePacket> ClientPlayNetworking.PlayChannelHandler createS2CHandler(Function<FriendlyByteBuf, T> decode, BiConsumer<T, Minecraft> handler) {
