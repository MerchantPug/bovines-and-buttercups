...
public class BovineEntityTypes {
    ...
    public static final RegistryObject<EntityType<FlowerCow>> MOOBLOOM = register("moobloom", () -> EntityType.Builder.of(FlowerCow::new, MobCategory.CREATURE).sized(0.9f, 1.4f).clientTrackingRange(10).build(BovinesAndButtercupsCommon.resourceLocation("moobloom").toString()));
