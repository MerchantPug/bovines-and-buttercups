...
public class CowLoader extends SimpleJsonResourceReloadListener {
    ...
    protected void apply(Map<ResourceLocation, JsonElement> prepared, ResourceManager resourceManager, ProfilerFiller profiler) {
        ...
        FlowerTypeRegistry.register(new FlowerType(Constants.resourceLocation("fire_flower"), "Fire Flower", null, Constants.resourceLocation("fire_flower"), "bovines", new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 10), true));
