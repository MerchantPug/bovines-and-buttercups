...
public class BovineBlocks {
    ...
    public static final RegistryObject<MoobloomFlowerBlock> LIMELIGHT = register("limelight", () -> new MoobloomFlowerBlock(MobEffects.REGENERATION, 8, BlockBehaviour.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final RegistryObject<MoobloomFlowerBlock> BIRD_OF_PARADISE = register("bird_of_paradise", () -> new MoobloomFlowerBlock(MobEffects.SLOW_FALLING, 6, BlockBehaviour.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<MoobloomFlowerBlock> HYACINTH = register("hyacinth", () -> new MoobloomFlowerBlock(MobEffects.POISON, 12, BlockBehaviour.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<MoobloomFlowerBlock> TROPICAL_BLUE = register("tropical_blue", () -> new MoobloomFlowerBlock(MobEffects.FIRE_RESISTANCE, 4, BlockBehaviour.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ)));
