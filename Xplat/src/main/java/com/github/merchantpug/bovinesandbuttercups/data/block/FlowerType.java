...
public record FlowerType(
    ...
    public static final FlowerType MISSING = new FlowerType(Optional.of(BovinesAndButtercups.asResource("missing_flower")), Optional.of("block.bovinesandbuttercups.custom_flower"), Optional.empty(), Optional.of(BovinesAndButtercups.asResource("missing_flower")), "bovines", Optional.of(BovinesAndButtercups.asResource("missing_flower_item")), "bovines", Optional.of(BovinesAndButtercups.asResource("potted_missing_flower")), "bovines", Optional.of(new MobEffectInstance(MobEffects.REGENERATION, 4)), false);
